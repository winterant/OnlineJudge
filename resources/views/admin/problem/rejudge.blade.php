    ...
    <div class="p-4 col-12 col-sm-8">
        ...
        <form action="" method="post">
            ...
            <div class="form-inline">
                <label for="">
                    选定时间区间：
                    <input type="datetime-local" name="date[1]" class="form-control" autocomplete="off" required>
                    <font class="mx-2">—</font>
                    <input type="datetime-local" name="date[2]" class="form-control" autocomplete="off" required>
                </label>
                <button class="btn btn-success bg-light mb-0 ml-3">确认重判</button>
            </div>
        </form>

    ...
    <div class="my-container bg-white">
      ...
      <form onsubmit="return submit_settings(this)" method="post">
        ...
        <div class="input-group mt-2">
          ...
          <input type="text" name="footer_info" value="{{ get_setting('footer_info') }}" class="form-control" autocomplete="off" placeholder="您可以将备案信息、交流群等信息填在此处，这些信息将显示在页脚位置。">
        </div>
        <div class="input-group mt-2">
          <div class="input-group-prepend">
            <span class="input-group-text">滚动公告：</span>
          </div>
          <input type="text" name="marquee_notice_id" value="{{ get_setting('marquee_notice_id') }}" class="form-control" autocomplete="off"
            placeholder="请填写一个公告编号，对应公告将在前台页面顶端滚动显示；不填则无滚动公告">
        </div>

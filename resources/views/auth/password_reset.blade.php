...
@section('content')
  <div class="container justify-content-center">
    <div class="row justify-content-center">
      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">{{ __('sentence.Reset Password') }}：<font class="text-danger">{{ $username }}</font>
          </div>
            ...
            <form method="POST" action="" autocomplete="off">
              ...
              <div class="form-group row">
                <label for="old_password"
                  class="col-md-4 col-form-label text-md-right">{{ __('main.Old Password') }}</label>
              ...
              <div class="form-group row">
                <label for="new_password"
                  class="col-md-4 col-form-label text-md-right">{{ __('main.New Password') }}</label>
              ...
              <div class="form-group row">
                <label for="password-confirm"
                  class="col-md-4 col-form-label text-md-right">{{ __('main.Confirm New Password') }}</label>

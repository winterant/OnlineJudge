<hr>
<div id="footer" class="text-center mb-3 pb-3">
  <div>
    <span id="localtime">{{ date('Y-m-d H:i:s') }}</span>
    <span class="mx-2">|</span>
    <a href="https://docs.lduoj.cn/web/" target="_blank">{{ __('main.Introduction') }}</a>
    <span class="mx-2">|</span>
    <a href="https://docs.lduoj.cn/web/judge.html" target="_blank">
      {{ __('main.Judge Service') }}
    </a>
    <span class="mx-2">|</span>
    <a href="https://docs.lduoj.cn/web/result.html" target="_blank">{{ __('main.Judge Result') }}</a>
